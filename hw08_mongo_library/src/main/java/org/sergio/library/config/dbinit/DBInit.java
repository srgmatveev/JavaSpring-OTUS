...
import org.sergio.library.services.AuthorService;
import org.sergio.library.services.BookService;
import org.sergio.library.services.GenreService;
...
public class DBInit implements DatasourceConfig {
    ...
    public DBInit(@Qualifier("genreService") GenreService genreService,
                  @Qualifier("bookService") BookService bookService,
                  @Qualifier("authorService") AuthorService authorService, MessageSource messageSource) {
