...
@Service("resultShellService")
public class ResultShellServiceImpl implements ResultService{
    private final PersonService personService;
    private final AskQuestionService askQuestionService;
    private final MessageSource ms;

    public ResultShellServiceImpl(@Qualifier("shellPersonService") PersonService personService, AskQuestionService askQuestionService, MessageSource ms) {
